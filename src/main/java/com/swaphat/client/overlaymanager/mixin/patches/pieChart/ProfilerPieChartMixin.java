...
public class ProfilerPieChartMixin {
    ...
    private int wrapWidth(GuiGraphics instance, Operation<Integer> original) {
    ...
    private int wrapHeight(GuiGraphics instance, Operation<Integer> original) {
    ...
    private void wrapPieSlices(GuiGraphics instance, List<ResultField> list, int minX, int minY, int maxX, int maxY, Operation<Void> original) {
